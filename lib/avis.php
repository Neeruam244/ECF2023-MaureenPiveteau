...
try{
    ...
    {
        $query = $pdo->prepare("SELECT * FROM opinions WHERE id = :id");
    ...
    {
        $query = $pdo->prepare("INSERT INTO opinions (client_name, opinion, imgNote) "
            ."VALUES(:client_name, :opinion, :imgNote)");  
        $query->bindValue(':id', $id, $pdo::PARAM_INT);
    ...
    {
        $query = $pdo->prepare("INSERT INTO opinions (opinion) "
            ."VALUES(:opinion)");  
        $query->bindValue(':id', $id, $pdo::PARAM_INT);
        $query->bindValue(':opinion', $opinion, $pdo::PARAM_STR);
        return $query->execute();  
